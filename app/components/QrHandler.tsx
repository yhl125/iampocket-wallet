  ...
  return (
    <div>
      {show ? (
        ...
        <button
          className="border-base-800 hover:bg-base-1000 focus:ring-base-700 mt-2 flex w-full flex-col items-center border border-dashed px-4 py-6 text-sm focus:outline-none focus:ring-2 focus:ring-offset-2"
